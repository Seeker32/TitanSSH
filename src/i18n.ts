...
const zhCN = {
  ...
  'host.keyPlaceholder': '点击浏览选择私钥文件', 'host.browse': '浏览…', 'host.passphrasePlaceholder': '留空则保持原口令不变',
  ...
  'sftp.explorer': '文件浏览器', 'sftp.queue': '传输队列', 'sftp.selectSession': '请选择会话', 'sftp.refresh': '刷新', 'sftp.upload': '上传', 'sftp.download': '下载',
...
const enUS: Record<keyof typeof zhCN, string> = {
  ...
  'host.keyPlaceholder': 'Browse to select a private key', 'host.browse': 'Browse…', 'host.passphrasePlaceholder': 'Leave blank to keep the current passphrase',
  ...
  'sftp.explorer': 'File browser', 'sftp.queue': 'Transfer queue', 'sftp.selectSession': 'Select a session', 'sftp.refresh': 'Refresh', 'sftp.upload': 'Upload', 'sftp.download': 'Download',
